...
def planning(goal):
    ...
    feedback = assign_2.msg.PlanningFeedback()
    result = assign_2.msg.PlanningResult()
...
def main():
    ...
    act_s = actionlib.SimpleActionServer('/reaching_goal', assign_2.msg.PlanningAction, planning, auto_start=False)
    act_s.start()
